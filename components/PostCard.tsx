...
import { Heart, MessageCircle, Share2, MapPin, Repeat, Bookmark } from 'lucide-react';
  ...
  return (
    <div className="card p-6 mb-6">
      ...
      <div className="flex justify-between text-zinc-400 pt-4 border-t border-zinc-800">
        ...
        <button className="flex items-center gap-2 hover:text-green-500"><Repeat size={22} /></button>
        ...
        <button onClick={toggleBookmark} className={`flex items-center gap-2 ${bookmarked ? 'text-teal-400' : 'hover:text-teal-400'}`}>
